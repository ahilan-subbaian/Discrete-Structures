...
(define (state student)
  (car (cdr (car (cdr (car (cdr (reverse student))))))))
...
(define (pig-latin word)
  (append (reverse (cons (car word) ( reverse (cdr word)))) '(a y)))
...
(define (yoda 3-words)
  (append (car (reverse 3-words)) (reverse (cdr (reverse 3-words)))))
